...
// Compile movie.cpp file with ncurses library
    std::cout<<"Generating movie.out in the current directory....\n";
    command = "g++ ./ASCII_Movie_Files/Source/movie.cpp -o movie.out -lncurses";
    execute(command.c_str());
    std::cout<<"Successfully generated movie.out file\n";
